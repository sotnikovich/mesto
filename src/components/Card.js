export default class Card {
    constructor(data, cardTemplate, userId, imagePopup, deleteCard, addCardLike, deleteCardLike) {
        this._data = data;
    ...
    _getTemplate() {
        const cardElement = document
            .querySelector(this._cardTemplate).content.querySelector('.element').cloneNode(true);
        return cardElement;
    }
